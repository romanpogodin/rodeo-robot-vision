...
//  radio.stopListening();  // Start the radio listening for data
  ...
  if (received_signal == 0) {
    ...
    Serial.println("STOP");
      ...
      go = 1;
      subtractor = 40;
    } else if (80 < received_signal < 121) {
      ...
      go = 1;
      subtractor = 80;
    } else if (120 < received_signal < 160) {
  ...
  delay(kDelay + (received_signal - subtractor)*10);
}
